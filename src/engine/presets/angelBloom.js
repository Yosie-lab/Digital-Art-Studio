...
const ANGEL_PARTICLE_GLOW = 1.68;
const ANGEL_BODY_OPACITY = 0.30;
const ANGEL_RIM_OPACITY = 0.66;
const ANGEL_WING_OPACITY = 0.24;
const ANGEL_WING_RIM_OPACITY = 0.58;
const ANGEL_HALO_OPACITY = 0.34;
const ANGEL_EYE_OPACITY = 0.80;
const ANGEL_MOUTH_OPACITY = 0.74;
const ANGEL_SPARKLE_OPACITY = 0.72;
const ANGEL_FALL_OPACITY = 0.68;
const ANGEL_FILL_BOOST = 1.52;
const ANGEL_WING_FILL_BOOST = 1.44;
const ANGEL_HALO_FILL_BOOST = 1.42;
const ANGEL_RIM_BOOST = 1.62;
  ...
  function syncMeshes() {
    ...
    if (sparkleField) {
      sparkles.forEach((s, i) => {
        ...
        const sc = angelParticleFill(angelColorAt(s.phase * 3 + i * 0.1), 1.52, 0.05);
    ...
    if (sparkleFieldLarge) {
      sparklesLarge.forEach((s, i) => {
        ...
        const pulse = 0.82 + 0.65 * Math.abs(Math.sin(time * 2.6 + s.phase));
        const sc = angelParticleFill(angelColorAt(s.phase * 3 + i * 0.17), 1.52, 0.05);
